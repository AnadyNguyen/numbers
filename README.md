...
A challenge was assigning the right variable to the user input. I assigned i to the user input instead of the variable num. Another challenge was forgetting to add changes to git before committing them.

## Resources
I used ChatGPT to check why my code was wrong, and all of the lecture slides about shell scripting. I also used YouTube to help me add, commit, and push my changes to the file.
